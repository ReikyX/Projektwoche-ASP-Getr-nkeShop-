...
namespace DrinkShop.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,Quantity,UserId")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,Quantity,UserId")] CartItem cartItem)
        {
            if (id != cartItem.Id)
            {
                return NotFound();
